...
public class RateListActivity3 extends ListActivity implements Runnable, AdapterView.OnItemClickListener{
        ...
        handler=new Handler(Looper.myLooper()){
            public void handleMessage(@NonNull Message msg){
                ...
                if(msg.what==6){
                    ...
                    MyAdapter myAdapter=new MyAdapter(RateListActivity3.this,R.layout.activity_rate_list3,listItems);
